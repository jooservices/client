...
```
docs/
├── 00-governance/     # Documentation governance
├── 01-overview/       # High-level understanding
├── 02-product-and-usage/  # User/product perspective
├── 03-architecture/   # System design
├── 04-engineering/    # Development and quality
├── 05-interfaces/     # Public APIs and contracts
├── 06-data/          # Data models and persistence
├── 07-operations/    # Deployment and ops
├── 08-security/      # Security considerations
├── 09-onboarding/    # New contributor guidance
└── 10-audit/         # Gaps, risks, and changelog
```
...
4. Update `10-audit/docs-changelog.md`
...
- [Documentation Changelog](../10-audit/docs-changelog.md)
