...
- [Link to related doc](../00-architecture/01-project-overview.md)
```
...
Extract examples from actual working code (tests or docs/03-examples/) when possible.
...
```markdown
See [System Architecture](../00-architecture/05-data-flow.md) for details.
```
