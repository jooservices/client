...
**Config**: `.github/workflows/quality.yml`
...
- ✅ CONTRIBUTING guide
- ✅ CHANGELOG
- ✅ 5 working PHP examples in `docs/user/examples/`
- ✅ Basic API reference in `docs/user/reference/`
...
- [Runtime and Dependencies](../04-engineering/runtime-and-dependencies.md)
