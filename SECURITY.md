...
| Version line | Status |
| --- | --- |
| `4.0.x` (this repository) | Supported — receives security fixes once released |
| Pre-release (`4.0.0` not yet tagged) | Report issues now so they are fixed before release |
